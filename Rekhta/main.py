...
for ghazal in ghazals:
    ghazals[ghazal]["Rekhta Youtube Links"] = [get_youtube_link(ghazals[ghazal]["Rekhta Link"])]
    ...
    ws2[f"B{curr_row2}"].options(transpose=True).value = ghazals[ghazal]["Rekhta Youtube Links"]
